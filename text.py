greet = "Привет, {name}! Я бот, в котором тренируется Ярослав, использующий нейросети от OpenAI, такие как ChatGPT и Dall-e. Задавай мне вопросы и я постараюсь ответить ☺️"
menu = "📍 Главное меню"
...
text_watermark = '\n_______________________________________\nСоздано при помощи https://tea29.ru'
img_watermark = "Создано при помощи https://tea29.ru"
gen_wait = "⏳Пожалуйста, подождите немного, пока нейросеть обрабатывает ваш запрос..."
gen_voice = "Отправьте текст запроса к нейросети для генерации голоса на Русском языке"
